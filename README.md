...
| [`skill-lint`](skills/skill-lint/SKILL.md) | Lint Codex CLI skills with selectable checks and report or fix modes. Use when asked to review, lint, evaluate, harden, find no-op instructions, reduce overprompting, security-review, or fix issues in another skill. |
