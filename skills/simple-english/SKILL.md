---
name: simple-english
description: Write or rewrite technical documentation with ASD-STE100 Simplified Technical English rules for clarity and translation. Use for documentation, READMEs, runbooks, procedures, error messages, release notes, incident reports, API guides, or explicit requests for STE, de-slopping, non-native readability, or translation-ready text.
---
...
When asked to write or rewrite technical text, operate only on the text or files in the user's requested scope. Do not rewrite system instructions, developer instructions, policies, `AGENTS.md`, prompts, or other control-plane files unless the user explicitly requests that target. Preserve normative strength and security meaning when you rewrite control-plane text.
...
5. **Apply the self-check** before you deliver. This step is not optional.
...
Fix what you find, then deliver. For a full audit, apply `references/checklist.md`.
